...
export default function Product(props) {
  ...
  return (
    <>
      ...
      <img src={staticProduct.images[0]} style={{maxWidth: '300px', height: 'auto'}} alt={staticProduct.title} /><br /><br />
      ...
      <Link href="/products"><button>Back to Product List</button></Link>
    </>
  );
}
